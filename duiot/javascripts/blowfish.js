function Blowfish(key) {
    this.init([
        this.P = Blowfish.prototype.P(key),
...
Blowfish.prototype.encrypt = function (view) {
    var e, buff, i;
    buff = new Uint32Array(view.length);
    for (i = 0; i < view.length; i += 2) {
        e = this.encipher(view[i], view[i + 1]);
        buff[i] = e.l;
        buff[i + 1] = e.r;
    }
    return buff;
};
Blowfish.prototype.decrypt = function (view) {
    var e, buff, i, c;
    buff = new Uint32Array(view.length);
    for (var i = 0; i < view.length; i += 2) {
        e = this.decipher(view[i], view[i + 1]);
        buff[i] = e.l;
        buff[i + 1] = e.r;
    }
    c = 0x00;
...
Blowfish.prototype.SBOX1 = function () {
    return[
...
Blowfish.prototype.SBOX2 = function () {
    return[
...
Blowfish.prototype.SBOX3 = function () {
    return[
...
Blowfish.prototype.SBOX4 = function () {
    return[
